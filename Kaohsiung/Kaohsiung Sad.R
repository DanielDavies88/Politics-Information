...
Han2018 <- subset(AllData, select = c("Date", "Page_Name", "Message", "All_Reaction_Count", "LIKE_COUNT", "SAD_COUNT","ANGRY_COUNT", "Share_Count"), subset = (Page_Name == ("韓國瑜")))
Han2018
Han2018 $ Date = as.POSIXct( Han2018 $ Date , format  =  " %Y/%m/%d %H:%M:%S " )


Hanall2018 <- subset(AllData, select = c("Date", "Page_Name", "Message", "All_Reaction_Count", "LIKE_COUNT","SAD_COUNT", "ANGRY_COUNT", "Share_Count"), subset = (Page_Name == ("韓國瑜")|(Page_Name == ("韓國瑜粉絲團"))|(Page_Name == ("韓國瑜新聞網"))|(Page_Name == ("高雄選韓國瑜News"))|(Page_Name == ("韓國瑜民間粉絲團（志工團"))|(Page_Name == ("高雄在地韓國瑜News"))|(Page_Name == ("侯友宜 盧秀燕 韓國瑜 北中南連線"))))
...
Chen2018<- subset(AllData, select = c("Date", "Page_Name", "Message", "All_Reaction_Count", "LIKE_COUNT", "SAD_COUNT" , "ANGRY_COUNT", "Share_Count"), subset = (Page_Name == ("陳其邁 Chen Chi-Mai")))
