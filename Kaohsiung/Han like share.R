...
plot(Hanall2018$LIKE_COUNT , nchar(Hanall2018$Message), type = "p",  xlim = 0, 5000, ylim = 0, 500)
...
qplot(Hanall2018$LIKE_COUNT, Hanall2018$Share_Count, xlim = c(0,2500),ylim= c(0,200))
